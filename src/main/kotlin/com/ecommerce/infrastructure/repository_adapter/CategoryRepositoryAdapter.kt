...
class CategoryRepositoryAdapter(
    ...
    override fun getPublicById(id: String): Category? {
        val model = categoryRepository.findPublicFullById(id).orElse(null)
        return CategoryEntityMapper.toDomain(model)
    }

    override fun getPublicBasicById(id: String): Category? {
        val model = categoryRepository.findPublicBasicById(id).orElse(null)
        return CategoryEntityMapper.toDomain(model)
    }
    ...
    override fun getAllPublic(): List<Category> {
        val models = categoryRepository.findAllBy(CategoryPublicFullProjection::class.java)
        return CategoryEntityMapper.toDomain(models, CategoryEntityMapper::toDomain)
    }
    ...
    override fun getAllPublicBasic(): List<Category> {
        val models = categoryRepository.findAllBy(CategoryPublicBasicProjection::class.java)
        return CategoryEntityMapper.toDomain(models, CategoryEntityMapper::toDomain)
    }
